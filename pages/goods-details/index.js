  ...
  onLoad: function (e) {
    ...
    wx.request({
      ...
      success: function(res) {
        ...
        var selectSizeTemp = "";
        var docnews = JSON.parse(res.data['docnews']);   
        console.log('goodsDetail', res.data.code)
        if (res.data.code==0) {
          ...
          // });
          that.setData({
            goodsDetail: docnews[0],
            selectSizePrice: res.data.docnews[0]['course_price'],
            // totalScoreToPay: res.data.data.basicInfo.minScore,
        ...
        //   buyNumber:(res.data.data.basicInfo.stores>0) ? 1: 0
        // });
        WxParse.wxParse('article', 'html', docnews[0].content, that, 5);
      }
    })
